...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'passionclub' => [
            'driver'        => 'mysql',
            'host'          => env('passionclub_DB_HOST'),
            'port'          => env('passionclub_DB_PORT', '3306'),
            'database'      => env('passionclub_DB_DATABASE'),
            'username'      => env('passionclub_DB_USERNAME', 'asenses'),
            'password'      => env('passionclub_DB_PASSWORD', ''),
            'unix_socket'   => env('passionclub_DB_SOCKET', ''),
            'charset'       => 'utf8mb4',
            'collation'     => 'utf8mb4_unicode_ci',
            'prefix'        => '',
            'strict'        => false,
        ...
        'famigliapregel' => [
            ...
            'database'      => env('pregel_DB_DATABASE'),
            'username'      => env('pregel_DB_USERNAME', 'asenses'),
            'password'      => env('pregel_DB_PASSWORD', ''),
            'unix_socket'   => env('pregel_DB_SOCKET', ''),
            'charset'       => 'utf8mb4',
            'collation'     => 'utf8mb4_unicode_ci',
            'prefix'        => '',
            'strict'        => false,
